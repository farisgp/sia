                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('jadwal.update', $row->id) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('id_kelas') is-invalid @enderror" name="id_kelas">
                                        ...
                                        @php
                                        $sel2 = ($kls->id == $row->id_kelas)? 'selected':'';
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('id_mata_pelajaran') is-invalid @enderror" name="id_mata_pelajaran">
                                        ...
                                        @php 
                                        $sel3 = ($mpl->id == $row->id_mata_pelajaran)? 'selected':'';
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('id_guru') is-invalid @enderror" name="id_guru">
                                        ...
                                        @php   
                                        $sel4 = ($gru->id == $row->id_guru)? 'selected':'';
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" value="{{ $row->waktu }}" name="waktu" class="form-control @error('waktu') is-invalid @enderror">
                                    @error('waktu')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
