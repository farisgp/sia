...
@section('content')
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            <div class="card-body">
                <h5 class="card-title">Data Guru Keluar</h5>
                ...
                <table class="table table-borderless datatable datatable table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">NIP</th>
                            <th scope="col">Tahun Pemberhentian</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                    ...
                                    <td width="15%">
                                        ...
                                        @else
                                            <img src="{{ url('admin/img') }}/{{ $row->foto }}" width="40%" alt="Profile"
                                                class="rounded-circle">
                                        @endempty
                                    </td>
                                    <td>{{ $row->nama_guru }}</td>
                                    <td>{{ $row->nip }}</td>
                                    <td width="20%">{{ $row->tahun_pemberhentian }}</td>
                                    <!-- <td width="50%">
