        ...
        <div class="card">
            ...
            <div class="tab-content pt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{  $row->nama_guru }}</div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{  $row->jabatan }}</div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-4 label">Jenis Guru</div>
                    <div class="col-lg-9 col-md-8">{{  $row->jenis_guru }}</div>
                </div>  
                <div class="row">
                    <div class="col-lg-3 col-md-4 label">Mengajar Kelas</div>
                    <div class="col-lg-9 col-md-8">
                        @foreach(json_decode( $row->id_kelas) as $kelas_id)
                            @php
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{  $row->kontak }}</div>
                </div>
