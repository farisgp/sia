                    ...
                    <div class="card-body">
                        <div class="alert alert-secondary container">
                            <div class="row">
                                ...
                                <div class="col">: {{ $row->nama_guru }}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2">NIP</div>
                                <div class="col">: {{ $row->nip }}</div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-2">Pengampu ( Mata Pelajaran )</div>
                                <div class="col">: {{ $row->mata_pelajaran->nama_mapel }}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2">Pengampu ( Guru Kelas )</div>
